...
def stkmove_new(strFunction):
    ...
    for strFROMDEVICE_index in range(len(shelf_name_list)):
        strFROMDEVICE.append((shelf_name_list[strFROMDEVICE_index]).encode('utf-8'))

    for strFROMPORT_index in range(len(shelf_port_list)):
         strFROMPORT.append((shelf_port_list[strFROMPORT_index]).encode('utf-8'))
    ...
    stk_dict = {
        "strFROMDEVICE":strFROMDEVICE,#貨架name_list
        "strFROMPORT":strFROMPORT,#貨架port
